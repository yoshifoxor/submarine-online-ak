  ...
  for (let [key, tekiPlayerObj] of gameObj.playersMap) {
    ...
    if (
      ...
      if (tekiPlayerObj.displayName === 'anonymous') {
        ...
        gameObj.ctxRader.lineTo(
          distanceObj.drawX + 20 + 40,
          distanceObj.drawY - 20
        );
        gameObj.ctxRader.stroke();

        gameObj.ctxRader.font = '8px Arial';
        gameObj.ctxRader.fillText(
          'anonymous',
          distanceObj.drawX + 20,
          distanceObj.drawY - 20 - 1
        );
  ...
  for (let [missileId, flyingMissile] of gameObj.flyingMissilesMap) {
    ...
    if (
      ...
      if (flyingMissile.emitPlayerId === gameObj.myPlayerObj.playerId) {
        ...
        gameObj.ctxRader.lineTo(
          distanceObj.drawX + 30 + 35,
          distanceObj.drawY - 30
        );
        gameObj.ctxRader.stroke();
        ...
        gameObj.ctxRader.fillText(
          'missile',
          distanceObj.drawX + 30,
          distanceObj.drawY - 30 - 2
        );
      }
    }
  }
